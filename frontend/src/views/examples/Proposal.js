...
const Proposal = (props) => {
  ...
  const studentMarksSubmit = (groupId, criteria) => {
    const data = {
            ...
            <Card className="shadow">
              <CardHeader className="border-0">
                <Row className="align-items-center">
                  <div className="col">
                    <h3 className="mb-0">
                      Assinged Projects - Proposal Evaluations
                    </h3>
                  </div>
                                ...
                                >
                                  ...
                                  <div>
                                    ...
                                    {p.projectEvaluationScore &&
                                      p.projectEvaluationScore.proposal
                                        .length !== 0 &&
                                      p.projectEvaluationScore.proposal.map(
                                        (proposal, index) => {
